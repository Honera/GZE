...
/*
 extern uLib* _rLasLib ;
 extern uLib* _rLasLib2;
 extern uLib* _rLasLib3;
extern  int nASS ;
extern  gzUInt32 nASS2 ;
extern  gzUInt32 nASS3 ;
...
/*
    //Lib_GZ was always loaded
    IniLib_Lib_GZ();
    Lib_GZ::Lib::NewClass(); //Temp ??
	*/
